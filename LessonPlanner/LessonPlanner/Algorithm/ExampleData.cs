...
namespace LessonPlanner
{
    static class ExampleData
    {
        ...
        //    algorithm.Classrooms = new List<Room>()
        //    {
        //        new Room(){Id = 1, IsLab = true, SeatCount = 24, Name = "R3"},
        //        new Room(){Id = 2, IsLab = false, SeatCount = 60, Name = "R7"},
        //    };
        ...
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 9), Course = algorithm.Courses.Find(p => p.Id == 1), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 1).ToList(), LessonDuration = 3, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 9), Course = algorithm.Courses.Find(p => p.Id == 1), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 2).ToList(), LessonDuration = 3, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 9), Course = algorithm.Courses.Find(p => p.Id == 1), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 3).ToList(), LessonDuration = 3, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 9), Course = algorithm.Courses.Find(p => p.Id == 1), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 4).ToList(), LessonDuration = 3, IsLabRequireq = true},
        ...
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 3), Course = algorithm.Courses.Find(p => p.Id == 2), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 1).ToList(), LessonDuration = 2, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 3), Course = algorithm.Courses.Find(p => p.Id == 2), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 2).ToList(), LessonDuration = 2, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 3), Course = algorithm.Courses.Find(p => p.Id == 2), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 3).ToList(), LessonDuration = 2, IsLabRequireq = true},
        //        new CourseClass(){Professor = algorithm.Professors.Find(p => p.Id == 3), Course = algorithm.Courses.Find(p => p.Id == 2), StudentGroups = algorithm.StudentGroups.Where(p => p.Id == 4).ToList(), LessonDuration = 2, IsLabRequireq = true},
