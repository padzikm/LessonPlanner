    ...
    static class ExampleData
    {
        public static void FillExampleData(this Configuration configuration)
        {
            ...
            configuration.CourseClasses = new List<CourseClass>()
            {
                ...
                new CourseClass(){Professor = configuration.Professors[9], Course = configuration.Courses[1], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 1).Select(p => p.Value).ToList(), LessonDuration = 3, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[9], Course = configuration.Courses[1], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 2).Select(p => p.Value).ToList(), LessonDuration = 3, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[9], Course = configuration.Courses[1], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 3).Select(p => p.Value).ToList(), LessonDuration = 3, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[9], Course = configuration.Courses[1], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 4).Select(p => p.Value).ToList(), LessonDuration = 3, IsLabRequireq = true},
                ...
                new CourseClass(){Professor = configuration.Professors[3], Course = configuration.Courses[2], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 1).Select(p => p.Value).ToList(), LessonDuration = 2, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[3], Course = configuration.Courses[2], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 2).Select(p => p.Value).ToList(), LessonDuration = 2, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[3], Course = configuration.Courses[2], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 3).Select(p => p.Value).ToList(), LessonDuration = 2, IsLabRequireq = true},
                new CourseClass(){Professor = configuration.Professors[3], Course = configuration.Courses[2], StudentGroups = configuration.StudentGroups.Where(p => p.Key == 4).Select(p => p.Value).ToList(), LessonDuration = 2, IsLabRequireq = true},
